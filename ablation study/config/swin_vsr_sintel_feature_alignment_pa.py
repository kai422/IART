# ./tools/dist_train23.sh configs/restorers/sintel_swin/swin_vsr_sintel_feature_alignment_pa.py 2
 
exp_name = 'swin_vsr_sintel_feature_alignment_pa'

# model settings
model = dict(
    type='VSRFlowInput',
    generator=dict(
        type='SintelSwinVSRNetFeatureAlignment', alignment = 'pa', interpolation = 'none'),
