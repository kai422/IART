# ./tools/dist_train45.sh configs/restorers/sintel_swin/swin_vsr_sintel_feature_alignment_fgda.py 2
 
exp_name = 'swin_vsr_sintel_feature_alignment_fgda'

# model settings
model = dict(
    type='VSRFlowInput',
    generator=dict(
        type='SintelSwinVSRNetFeatureAlignment', alignment = 'fgda', interpolation = 'none'),
