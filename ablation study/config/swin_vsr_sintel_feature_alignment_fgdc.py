# ./tools/dist_train45.sh configs/restorers/sintel_swin/swin_vsr_sintel_feature_alignment_fgdc.py 2
 
exp_name = 'swin_vsr_sintel_feature_alignment_fgdc'

# model settings
model = dict(
    type='VSRFlowInput',
    generator=dict(
        type='SintelSwinVSRNetFeatureAlignment', alignment = 'fgdc', interpolation = 'none'),
