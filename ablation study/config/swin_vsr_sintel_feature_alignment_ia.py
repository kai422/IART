# ./tools/dist_train67.sh configs/restorers/sintel_swin/swin_vsr_sintel_feature_alignment_ia.py 2
 
exp_name = 'swin_vsr_sintel_feature_alignment_ia'

# model settings
model = dict(
    type='VSRFlowInput',
    generator=dict(
        type='SintelSwinVSRNetFeatureAlignment', alignment = 'ia', interpolation = 'none'),
