# CUDA_VISIBLE_DEVICES=6,7 PORT=12367 ./tools/dist_train.sh configs/restorers/sintel_swin/swin_vsr_sintel_feature_alignment_bilinear.py 2
 
exp_name = 'swin_vsr_sintel_feature_alignment_bilinear'

# model settings
model = dict(
    type='VSRFlowInput',
    generator=dict(
        type='SintelSwinVSRNetFeatureAlignment', alignment = 'of_warp', interpolation = 'bilinear'),
