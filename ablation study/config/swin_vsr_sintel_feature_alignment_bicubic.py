# CUDA_VISIBLE_DEVICES=2,3 PORT=12323 ./tools/dist_train.sh configs/restorers/sintel_swin/swin_vsr_sintel_feature_alignment_bicubic.py 2
 
exp_name = 'swin_vsr_sintel_feature_alignment_bicubic'

# model settings
model = dict(
    type='VSRFlowInput',
    generator=dict(
        type='SintelSwinVSRNetFeatureAlignment', alignment = 'of_warp', interpolation = 'bicubic'),
