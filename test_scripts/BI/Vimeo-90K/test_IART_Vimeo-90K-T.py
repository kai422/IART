...
def main():
    ...
    crop_border = 0
    # model
    model_path = 'experiments/pretrained_models/IART_Vimeo-90K_BI.pth' 
    # test data
    test_name = f'Vimeo90K_150k_Interval{interval}-woflip'

    lr_folder = 'datasets/vimeo90k/BIx4'
    ...
    # load video names
    vimeo_motion_txt= 'datasets/vimeo90k/meta_info_Vimeo90K_test_GT.txt'
    subfolder_names = []
    avg_psnr_l = []
    avg_ssim_l = []
